...
def verif(tableau):
    """ Entrées : un tableau "carré"
        Sorties : Calcule les sommes de chaque ligne/colonne/diagonale et vérifie l'alignement."""
    ...
    return 0
def gagner(a):
    """Cette fonction indique le gagnant en modifiant le message et en renvoyant la valeur 9."""
    if a == 1:
